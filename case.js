...
`
	                let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://chat.whatsapp.com/GRztipN63SKDVG8duGYj11'
                                }
                            }]
...
var button = [{ buttonId: `allmenu`, buttonText: { displayText: `MENU BOT` }, type: 1 }, { buttonId: `rules`, buttonText: { displayText: `RULES BOT` }, type: 1 }]
...
۞ BOT INFO
𖣔 ${global.botname}
𖣔 Contact My Owner : 083129240927
𖣔 Time: ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}
𖣔 STATUS* : ${ALYA.public ? 'Public' : 'Self'} 
✞︎ ︎︎︎${global.botname} ✞︎

✞︎︎─────────ᴀᴜᴛʜᴏʀ──────────✞︎
۞ ɴᴀᴍᴀ : ᴀᴅɪᴛ
۞ ᴡᴀ ᴀᴜᴛʜᴏʀ : 083129240927
۞ ʀᴇɢɪᴏɴ : ɪɴᴅᴏɴᴇsɪᴀ
۞ ᴀsᴀʟ : ᴍᴀᴛᴀʀᴀᴍ
۞ sᴛᴀᴛᴜs : sᴇᴋᴏʟᴀʜ
۞ ᴛɪᴅᴀᴋ ʙᴀɴʏᴀᴋ ʙɪᴄᴀʀᴀ
...
𖣔 Your Progress:
𖣔 Level: ${user.level}
𖣔 XP: ${user.exp} / ${user.jembut}
𖣔 Role: ${role}
𖣔 Your Balance: $${user.uangku}


۞BOT STATUS 
𖣔 ${runtime(process.uptime())}
𖣔 Auto-Regis User: ${te}
𖣔 Total Hit Bot : ${jumlahcmd}
𖣔 Total Hit Today : ${jumlahharian}
...
/*case 'menu': case 'help': case '?': {                
                buffer = await getBuffer(`https://telegra.ph/file/cb25fe7572390cdbf9302.jpg`)
                no = 1
                anu = `Hai kak ${pushname}, have a nice day:)
                           
۞INFO - BOT
𖣔 Bot Name: ${global.botname}
𖣔 Owner Name: ${global.ownername}
𖣔 Runtime: ${runtime(process.uptime())}
𖣔 Gc Bot: ${global.gc}
𖣔 Tanggal: ${moment.tz('Asia/Jakarta').format('DD/MM/YY')}
𖣔 Waktu: ${moment.tz('Asia/Jakarta').format('HH:mm:ss')}           
𖣔 Library: Baileys-Md

Memperingati Hari Pancasila
${ultah}

۞ YOUR - INFO
𖣔 Your Name: ${pushname}
𖣔 Your Limit: ${limit}
𖣔 Total Hit: ${jumlahcmd}
𖣔 Total Hit Today: ${jumlahharian}
